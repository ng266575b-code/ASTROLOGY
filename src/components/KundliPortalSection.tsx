...
export function KundliPortalSection() {
  ...
  return (
    <section id="kundli" className="py-24 px-6 lg:px-20 bg-slate-50 relative overflow-hidden">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-purple-100/50 blur-[150px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          >
            <GlassCard glowColor="aurora" className="p-8 border-2 border-aurora-purple/30 bg-white/40">
              <h3 className="font-heading text-2xl font-bold text-gray-900 mb-6">Birth Details</h3>
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full bg-white/40 border border-gray-300/20 rounded-lg py-2 px-3 text-gray-900 outline-none focus:border-aurora-purple transition-colors"
                    required
                  />
                </div>
                <div>
                ...
                <div>
                  <label className="block text-sm text-gray-600 mb-1">Time of Birth</label>
                  <input 
                    type="time" 
                    value={formData.time}
          ...
          >
            {!isGenerated ? (
              <GlassCard glowColor="gold" className="w-full h-[600px] flex flex-col items-center justify-center p-8 border-2 border-dashed border-gray-300/20 bg-white/20 text-center">
                <div className="w-24 h-24 mb-6 rounded-full bg-white/5 border border-gray-300/10 flex items-center justify-center">
                  <span className="text-4xl opacity-50">🔮</span>
                </div>
                <h3 className="text-xl font-heading font-bold text-gray-700 mb-2">Awaiting Birth Details</h3>
              ...
              <div className="w-full h-full flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-12">
                ...
                <GlassCard glowColor="aurora" className="p-6 border border-aurora-purple/50 bg-white/60 shadow-[0_0_20px_rgba(157,0,255,0.2)]">
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-heading text-xl font-bold text-celestial-gold">
                      Tentative Prediction for {formData.name}
                    </h3>
                    <span className="text-xs bg-white/10 text-gray-600 px-2 py-1 rounded">AI Generated</span>
                  </div>
                ...
                <div className="flex-1 w-full rounded-2xl overflow-hidden border-2 border-gray-300/10 shadow-[0_0_30px_rgba(0,0,0,0.5)] bg-slate-50 flex flex-col items-center justify-center relative min-h-[400px]">
                  <div className="absolute top-4 left-6 z-20">
                    <h4 className="text-celestial-gold font-bold tracking-widest text-sm uppercase">Natal Chart</h4>
                    <p className="text-xs text-gray-600">Precision Generated</p>
                  </div>
