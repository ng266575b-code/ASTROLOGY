      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-md bg-slate-50 border border-red-500/30 rounded-2xl p-8 shadow-[0_0_50px_rgba(255,0,0,0.15)] text-center overflow-hidden"
          >
            ...
            <h3 className="text-2xl font-heading font-bold text-gray-900 mb-4">Authentication Required</h3>
            ...
            <div className="flex gap-4 justify-center">
              <button 
                onClick={onClose}
                className="px-6 py-2 rounded-full border border-gray-300/20 text-gray-900 font-bold hover:bg-white/10 transition-colors"
              >
                Cancel
              </button>
              <Link 
