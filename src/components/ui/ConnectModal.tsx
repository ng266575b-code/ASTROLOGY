      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-md bg-slate-50 border border-gray-300/10 rounded-2xl p-8 shadow-[0_0_50px_rgba(212,175,55,0.15)] overflow-hidden"
          >
            {/* Decorative elements */}
            ...
            <div className="text-center mb-8 relative z-10">
              ...
              <h3 className="text-2xl font-heading font-bold text-gray-900 mb-1">Sri Surmadhur Pant</h3>
              <p className="text-sm text-celestial-gold font-semibold uppercase tracking-widest">Astrologer Consultant</p>
            </div>

            <div className="space-y-4 relative z-10">
              {/* Chat Option */}
              <div className="flex items-center justify-between p-4 bg-white/5 border border-gray-300/10 rounded-xl hover:bg-white/10 transition-colors cursor-pointer group">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900">Half an hour Chat</h4>
                    <p className="text-xs text-gray-600">Direct WhatsApp Session</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between p-4 bg-white/5 border border-gray-300/10 rounded-xl hover:bg-white/10 transition-colors cursor-pointer group">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900">Direct Phone Call</h4>
                    <p className="text-xs text-gray-600">Detailed Audio Consultation</p>
                  </div>
                </div>
