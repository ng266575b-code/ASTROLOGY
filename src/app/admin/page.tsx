  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <GlassCard glowColor="aurora" className="p-6 bg-white/80 border border-red-500/20">
          <h3 className="text-sm text-gray-600 uppercase tracking-widest mb-2">Total Registered Users</h3>
          <div className="text-4xl font-bold text-gray-900">
            {loading ? "..." : users.length}
          </div>
        </GlassCard>
        
        <GlassCard glowColor="aurora" className="p-6 bg-white/80 border border-gray-300/10">
          <h3 className="text-sm text-gray-600 uppercase tracking-widest mb-2">System Status</h3>
      ...
      {/* User Database Table */}
      <GlassCard glowColor="aurora" className="p-0 bg-white/80 border border-gray-300/10 overflow-hidden">
        <div className="p-6 border-b border-gray-300/10 flex items-center justify-between">
          <h2 className="text-xl font-bold text-gray-900">User Database</h2>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-white/5 border-b border-gray-300/10">
                <th className="p-4 text-xs font-bold text-gray-600 uppercase tracking-wider">UID</th>
                ...
                <th className="p-4 text-xs font-bold text-gray-600 uppercase tracking-wider">Role</th>
              </tr>
            </thead>
            <tbody>
              {loading ? (
                ...
                users.map((user, i) => (
                  <tr key={user.uid || i} className="border-b border-gray-300/5 hover:bg-white/5 transition-colors">
