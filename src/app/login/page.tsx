  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-100 relative overflow-hidden px-4">
      ...
      <div className="absolute top-8 left-8 z-50">
        <Link 
          href="/"
          className="text-gray-600 hover:text-gray-900 flex items-center gap-2 transition-colors bg-white/20 p-2 rounded-lg backdrop-blur-md"
        >
          <ArrowLeft size={20} />
          Back to Cosmos
        </Link>
      ...
      <div className="bg-slate-50/80 backdrop-blur-xl p-10 rounded-2xl border border-gray-300/10 max-w-md w-full shadow-[0_0_40px_rgba(212,175,55,0.15)] relative z-10">
        ...
        <h2 className="text-3xl font-heading font-bold text-gray-900 mb-2 text-glow-gold text-center">
        ...
        <div className="flex flex-col gap-4">
            ...
            {!isLogin && (
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-white/40 border border-gray-300/20 rounded-lg py-3 px-4 text-gray-900 outline-none focus:border-celestial-gold transition-colors"
                  required={!isLogin}
                />
              </div>
            )}
          ...
          <div className="relative flex items-center py-2 mt-2">
            <div className="flex-grow border-t border-gray-300/10"></div>
          ...
          <button 
            ...
            disabled={loading}
            className="w-full border border-gray-300/20 bg-white/40 hover:bg-white/10 text-gray-900 font-bold py-3 px-4 rounded-xl transition-colors flex items-center justify-center gap-3 disabled:opacity-50"
          >
