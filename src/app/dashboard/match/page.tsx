...
export default function DashboardMatch() {
  return (
    <div className="flex flex-col items-center justify-center py-12">
      <h1 className="text-4xl font-heading font-bold text-gray-900 mb-4">Synastry & Compatibility</h1>
      <p className="text-gray-600 mb-12">Check your cosmic alignment with your partner.</p>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">
        <GlassCard glowColor="aurora" className="p-8 bg-white/60">
          ...
          <p className="text-center font-bold text-gray-900">Satyam</p>
        </GlassCard>

        <GlassCard glowColor="gold" className="p-8 bg-white/60">
          ...
          <form className="flex flex-col gap-4">
            <input type="text" placeholder="Partner's Name" className="bg-white/50 border border-gray-300/20 rounded-lg px-4 py-2 text-gray-900" />
            <input type="date" className="bg-white/50 border border-gray-300/20 rounded-lg px-4 py-2 text-gray-900" />
